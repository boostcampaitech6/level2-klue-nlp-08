...
file_path = '/data/ephemeral/level2-klue-nlp-08/EDA/train_split_v1.csv'
df = pd.read_csv(file_path)

# 'no_relation' 레이블을 가진 데이터 중 25%를 무작위로 선택하여 삭제하여 언더샘플링 수행
percentage_to_delete = 0.25
...
new_file_path = '/data/ephemeral/level2-klue-nlp-08/EDA/train_split_v2.csv'
